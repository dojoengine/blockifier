...
pub const SECP256K1_ADD_GAS_COST: u64 = 306 * STEP_GAS_COST + 29 * RANGE_CHECK_GAS_COST;
pub const SECP256K1_GET_POINT_FROM_X_GAS_COST: u64 =
    291 * STEP_GAS_COST + 30 * RANGE_CHECK_GAS_COST + 20 * MEMORY_HOLE_GAS_COST;
pub const SECP256K1_GET_XY_GAS_COST: u64 =
    139 * STEP_GAS_COST + 11 * RANGE_CHECK_GAS_COST + 40 * MEMORY_HOLE_GAS_COST;
pub const SECP256K1_MUL_GAS_COST: u64 = 76301 * STEP_GAS_COST + 7045 * RANGE_CHECK_GAS_COST;
pub const SECP256K1_NEW_GAS_COST: u64 =
    375 * STEP_GAS_COST + 35 * RANGE_CHECK_GAS_COST + 40 * MEMORY_HOLE_GAS_COST;
pub const SECP256R1_ADD_GAS_COST: u64 = 489 * STEP_GAS_COST + 57 * RANGE_CHECK_GAS_COST;
pub const SECP256R1_GET_POINT_FROM_X_GAS_COST: u64 =
    410 * STEP_GAS_COST + 44 * RANGE_CHECK_GAS_COST + 20 * MEMORY_HOLE_GAS_COST;
pub const SECP256R1_GET_XY_GAS_COST: u64 =
    141 * STEP_GAS_COST + 11 * RANGE_CHECK_GAS_COST + 40 * MEMORY_HOLE_GAS_COST;
pub const SECP256R1_MUL_GAS_COST: u64 = 125140 * STEP_GAS_COST + 13961 * RANGE_CHECK_GAS_COST;
pub const SECP256R1_NEW_GAS_COST: u64 =
    494 * STEP_GAS_COST + 49 * RANGE_CHECK_GAS_COST + 40 * MEMORY_HOLE_GAS_COST;
